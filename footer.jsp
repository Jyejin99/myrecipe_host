...
<body>
    ...
    <div class="container">
        ...
        <div class="col mb-3">
            ...
            <li class="nav-item mb-2"><a href="#" class="nav-link p-0">MyRecipe</a></li>
            <li class="nav-item mb-2"><a href="#" class="nav-link p-0">sunmoon uni</a></li>
            </ul>
        </div>
        ...
        <div class="col mb-3">
            ...
            <ul class="nav flex-column footer-list">
            <li class="nav-item mb-2"><a href="#" class="nav-link p-0">recipe@sunmoon.ac.kr</a></li>
            <li class="nav-item mb-2"><a href="#" class="nav-link p-0">041-333-5555</a></li>
